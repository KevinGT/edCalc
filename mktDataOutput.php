...
<?php
	...
	echo "<th>Buy</th>";
	echo "<th>Demand</th>";
	echo "<th>Demand Level</th>";
	echo "<th>Supply</th>";
	echo "<th>Supply Level</th>";
	echo "<th>Galactic Average</th>";
	echo "</tr>";

// connect to database
$cxn=mysqli_connect('localhost','root','','edmarket') or die('unable to connect to database');
// send query to the database
$sql= "SELECT * FROM mkt_data WHERE mkt_data.Station = '{$_POST['station']}'";
// echo $sql;
...
while($i<$num) {
	...
	$buy = $row['Buy'];
	$demand = $row['Demand'];
	$demandLvl = $row['Demand_Level'];
	$supply = $row['Supply'];
	$supplyLvl = $row['Supply_Level'];
	$GalAv = $row['Galactic_Average'];
	...
	echo "<td>" . $buy . "</td>";
	echo "<td>" . $demand . "</td>";
	echo "<td>" . $demandLvl . "</td>";
	echo "<td>" . $supply . "</td>";
	echo "<td>" . $supplyLvl . "</td>";
	echo "<td>" . $GalAv . "</td>";
	echo "</tr>";
